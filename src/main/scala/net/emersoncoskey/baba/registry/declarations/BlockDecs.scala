...
trait BlockDecs {
	...
	def block(name: String, props: => Properties, mods: SimpleDecMod[Block]*): Register[RegistryObject[Block]] =
		block(name, new Block(_), props, mods:_*)

	def block[B <: Block](name: String, ctor: Properties => B, mods: DecMod[Block, B]*): Register[RegistryObject[B]] =
